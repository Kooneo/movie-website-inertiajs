            ...
            <div class="mx-auto sm:px-6 lg:px-8">
                <section class="container mx-auto p-6 font-mono">
                    <div class="w-full flex mb-4 p-2 justify-end">
                        <Link :href="route('admin.tags.create')" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-800">Create Tag</Link>
                    </div>
                        ...
                        <div class="w-full overflow-x-auto">
                            <table class="w-full">
                                ...
                                <tr v-for="tag in tags.data" :key="tag.id" class="text-gray-700" >
                                    ...
                                    <td class="px-4 py-3 text-ms border">{{ tag.slug }}</td>

                                    <td class="px-4 py-3 text-sm border flex justify-end">
                                        <button class="bg-green-500 hover:bg-green-700 text-white px-4 py-2 rounded-lg">Edit</button>
                                        <button class="bg-red-500 hover:bg-red-700 text-white px-4 py-2 rounded-lg ml-2">Delete</button>
                                    </td>
                                </tr>
                                </tbody>
